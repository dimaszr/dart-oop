...
void main() {
  ...
  print(
      "ini Segitiga ${segitiga1.jenis} dengan alas ${segitiga1.alas}cm dan tinggi ${segitiga1.tinggi}cm");
  Segitiga segitiga2 = Segitiga.samasisi(8, 10, "sama sisi");
  print(
      "ini Segitiga ${segitiga2.jenis} dengan alas ${segitiga2.alas}cm dan tinggi ${segitiga2.tinggi}cm");
}
